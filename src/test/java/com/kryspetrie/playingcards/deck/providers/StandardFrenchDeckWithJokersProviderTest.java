...
class StandardFrenchDeckWithJokersProviderTest {
    ...
    private static final Set<Card> CARDS_IN_DECK = ImmutableSet.of(
            ...
            FrenchSuitCardConstants.BLACK_JOKER, FrenchSuitCardConstants.RED_JOKER);

    private final DeckProvider provider = new StandardFrenchDeckWithJokersProvider();
